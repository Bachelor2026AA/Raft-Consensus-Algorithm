...
func (x *AppendEntryRequest) GetEntry() []string {
	if x != nil {
		return x.Entry
	}
	return nil
...
var file_raft_proto_depIdxs = []int32{
	...
	2, // 1: raft.Raft.AppendEntries:input_type -> raft.AppendEntryRequest
	1, // 2: raft.Raft.RequestVote:output_type -> raft.RequestVoteResponse
	3, // 3: raft.Raft.AppendEntries:output_type -> raft.AppendEntryResponse
